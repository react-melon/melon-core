define('melon-core/table/Row', [
    ...
    var cx = require('melon-classname').create('TableRow');
    var TableCell = require('./Cell');
    var TableRow = React.createClass({
        displayName: 'TableRow',
        renderCell: function renderCell(columnData, index) {
        ...
        render: function render() {
            ...
            return React.createElement('div', babelHelpers.extends({}, rest, {
