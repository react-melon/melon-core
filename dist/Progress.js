define('melon-core/Progress', [
    ...
    var cx = require('melon-classname').create('Progress');
    var Progress = React.createClass({
        ...
        barUpdate: function barUpdate(step, barName, stepValues) {
            step = step || 0;
            step %= 4;
        ...
        render: function render() {
            ...
            return React.createElement('div', babelHelpers.extends({}, props, { className: className }), shape === 'circle' ? this.renderCircle() : this.renderLinear());
        }
    });
    Progress.SIZES = {
        xxs: 0.75,
