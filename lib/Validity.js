(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './classname/cxBuilder', './validator/Validity', './util/shallowEqual', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./classname/cxBuilder'), require('./validator/Validity'), require('./util/shallowEqual'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.cxBuilder, global.Validity, global.shallowEqual, global.babelHelpers);
        global.Validity = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _cxBuilder, _Validity, _shallowEqual, babelHelpers) {
    'use strict';
    ...
    var Validity = function (_PureComponent) {
        babelHelpers.inherits(Validity, _PureComponent);

        function Validity() {
            babelHelpers.classCallCheck(this, Validity);
            return babelHelpers.possibleConstructorReturn(this, _PureComponent.apply(this, arguments));
        }
