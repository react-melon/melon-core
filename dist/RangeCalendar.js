define('melon-core/RangeCalendar', [
    'require',
    'exports',
    'module',
    './babelHelpers',
    ...
    var cx = require('melon-classname').create('RangeCalendar');
    var RangeCalendar = React.createClass({
        ...
        onDateChange: function onDateChange(index, e) {
            var value = e.value;
            var date = [].concat(babelHelpers.toConsumableArray(this.state.date));
            date[index] = value;
            this.setState({
                date: date,
                month: date
        ...
        render: function render() {
            ...
            return React.createElement('div', babelHelpers.extends({}, others, { className: cx(props).addStates({ focus: open }).build() }), React.createElement('input', {
                name: name,
                ref: 'input',
                type: 'hidden',
                value: value.join(','),
    ...
    RangeCalendar.defaultProps = babelHelpers.extends({}, Calendar.defaultProps, {
        value: [
    ...
    RangeCalendar.propTypes = babelHelpers.extends({}, Calendar.propTypes, {
