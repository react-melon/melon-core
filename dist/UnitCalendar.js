define('melon-core/UnitCalendar', [
    'require',
    'exports',
    'module',
    './babelHelpers',
    ...
    var cx = require('melon-classname').create('UnitCalendar');
    var UnitCalendar = React.createClass({
        ...
        calculate: function calculate(current, next) {
        ...
        stringifyValue: function stringifyValue() {
            var _this2 = this;
            var value = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
        ...
        render: function render() {
            ...
            return React.createElement('div', { className: cx(this.props).build() }, React.createElement(BoxGroup, babelHelpers.extends({}, rest, {
                boxModel: 'checkbox',
                onChange: onChange,
                value: value
