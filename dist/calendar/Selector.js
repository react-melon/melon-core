define('melon-core/calendar/Selector', [
    'require',
    'exports',
    'module',
    '../babelHelpers',
    ...
    var cx = require('melon-classname').create('CalendarSelector');
    ...
    var CalendarSelector = React.createClass({
        ...
        render: function render() {
            ...
            return React.createElement('ul', babelHelpers.extends({}, rest, { className: cx(this.props).build() }), children);
        },
