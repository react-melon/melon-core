define('melon-core/BoxGroup', [
    ...
    var cx = require('melon-classname').create('BoxGroup');
    ...
    var BoxGroup = React.createClass({
        ...
        onChange: function onChange(e) {
            ...
            if (boxModel === 'radio') {
                ...
                if (index === -1) {
                    nextValue = [].concat(babelHelpers.toConsumableArray(value), [optionValue]);
                } else {
                    nextValue = [].concat(babelHelpers.toConsumableArray(value.slice(0, index)), babelHelpers.toConsumableArray(value.slice(index + 1)));
                }
            }
            this.props.onChange({
                type: 'change',
