define('melon-core/Tree', [
    ...
    var cx = require('melon-classname').create('Tree');
    ...
    var Tree = React.createClass({
        ...
        onTreeNodeClick: function onTreeNodeClick(e) {
        ...
        renderTreeNode: function renderTreeNode(children, level) {
            if (!children) {
                return;
            }
        ...
        render: function render() {
            ...
            return React.createElement('ul', babelHelpers.extends({}, props, { className: cx(props).build() }), this.renderTreeNode(children, 1));
        }
    });
