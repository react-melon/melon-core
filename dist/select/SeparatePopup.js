define('melon-core/select/SeparatePopup', [
    'require',
    'exports',
    'module',
    '../babelHelpers',
    ...
    var cx = require('melon-classname').create('SeparatePopup');
    ...
    var SelectSeparatePopup = React.createClass({
        ...
        componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
            ...
            this.setState(babelHelpers.extends({}, this.state, { styles: this.getStyle(open) }));
        },
        componentWillUnmount: function componentWillUnmount() {
            domUtil.off(window, 'resize', this.onWindowResize);
            domUtil.off(document.body, 'click', this.onClick);
        },
        getStyle: function getStyle(open) {
            if (!open) {
        ...
        onWindowResize: function onWindowResize() {
            this.setState(babelHelpers.extends({}, this.state, { styles: this.getStyle(true) }));
        },
        render: function render() {
            ...
            return React.createElement(Motion, {
                ...
                return React.createElement('div', {
                    className: className,
                    style: babelHelpers.extends({}, style, { visibility: style.opacity < 0.1 ? 'hidden' : 'visible' }),
