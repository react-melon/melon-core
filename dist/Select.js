define('melon-core/Select', [
    ...
    var Select = React.createClass({
        ...
        onPopupHide: function onPopupHide(e) {
            this.hideOptions();
        },
        ...
        renderOptGroup: function renderOptGroup(group) {
            var _this3 = this;
        ...
        renderOption: function renderOption(option, isGroupDisabled) {
        ...
        findOption: function findOption(value, children) {
